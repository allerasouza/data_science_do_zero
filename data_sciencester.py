...
# Inicialize o dict com uma lista vazia para da id de usuário:
...
# As chaves são interesses, os valoressão listas de user_ids com o interesse em questão
...
# As chaves são buckets de ano de experiência, os valores são as listas de salários associados ao bucket em questão
salary_by_tenure_bucket = defaultdict(list)
for salary, tenure in salaries_and_tenures:
  bucket = tenure_bucket(tenure)
  salary_by_tenure_bucket[bucket].append(salary)

# As chaves são buckets de ano de experiência, os valores são a média salarial do bucket em questão.
